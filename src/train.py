...
import config
from serving.db import get_current_batch, get_engine, get_labeled_predictions, init_db
...
def main():
    ...
    with logfire.span("train_challenger", n_rows=len(train_df)):
        with mlflow.start_run() as run:
            ...
            logfire.info("challenger_trained", run_id=run.info.run_id, version=version, n_rows=len(train_df))
